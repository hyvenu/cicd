...
class Employee(AuditUuidModelMixin):
    ...
    admin_rights = models.CharField(max_length=255, default="",null=True)
    attendance_id = models.CharField(max_length=255, default="",null=True)
    pan_card = models.CharField(max_length=255, default="",null=True)
    account_number = models.BigIntegerField(null=True, blank=True, default=0,)
    ifsc = models.CharField(max_length=255, default="",null=True)
    hrms_id = models.CharField(max_length=255, default="",null=True)
    ...
    pay_out = models.CharField(max_length=255, default="",null=True)
    grade = models.CharField(max_length=255, default="",null=True)
    login_access = models.CharField(max_length=255, default="",null=True)
