...
class MembersDetails(AuditUuidModelMixin):
    ...
    locality = models.CharField(max_length=255, default=None,blank=True)
    ...
    attendance_id = models.CharField(max_length=255, default=None,blank=True)
    club_id = models.CharField(max_length=255, default=None,blank=True)
    gst_no = models.CharField(max_length=255, default=None,blank=True)
    ...
    relationship = models.CharField(max_length=255, default=None,blank=True)
    notification = models.CharField(max_length=255, default=None,blank=True)
    sms = models.CharField(max_length=255, default=None,blank=True)
    ...
    company_name = models.CharField(max_length=255, default=None,blank=True)
