...
class Employee(AuditUuidModelMixin):
    ...
    doj = models.CharField(max_length=255, default=None,null=True)
    ...
    admin_rights = models.CharField(max_length=255, default=None,null=True)
    attendance_id = models.CharField(max_length=255, default=None,null=True)
    pan_card = models.CharField(max_length=255, default=None,null=True)
    account_number = models.BigIntegerField(null=True, blank=True, default=0,)
    ifsc = models.CharField(max_length=255, default=None,null=True)
    hrms_id = models.CharField(max_length=255, default=None,null=True)
    gender = models.CharField(max_length=255, default=None,null=True)
    employee_category = models.CharField(max_length=255, default=None,null=True)
    pay_out = models.CharField(max_length=255, default=None,null=True)
    grade = models.CharField(max_length=255, default=None,null=True)
    login_access = models.CharField(max_length=255, default=None,null=True)
