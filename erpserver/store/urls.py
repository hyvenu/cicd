...
urlpatterns = (
    ...
    path('api/v1/get_app_forbill/<app_id>/', views.get_app_forbill, name="get_app_forbill"),
    path('api/v1/save_appointment', views.save_Appointment, name="save_appointment"),
    path('api/v1/delete_appointment/<app_id>/', views.delete_booking, name="delete_booking"),
