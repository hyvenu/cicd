...
class VendorMaster(AuditUuidModelMixin):
    ...
    vendor_email = models.CharField(max_length=30, default="")
    ...
    mobile_num = models.CharField(max_length=15, default="")
    ...
    adhar_doc = models.ImageField(upload_to="static/upload/vendor/adhar_doc", null=True, blank=True, default=None)
